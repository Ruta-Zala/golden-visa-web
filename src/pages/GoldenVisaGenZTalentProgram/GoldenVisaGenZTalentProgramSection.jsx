...
export default function GoldenVisaGenZTalentProgramSection({ referralAddress }) {
  ...
  const fetchRequiredAmount = async () => {
    ...
    try {
      ...
      const calculatedAmount = ethers.utils.formatUnits(requiredAmount, selectedToken.decimals);
      const tenPercent = parseFloat(calculatedAmount) * 0.10;
      const adjustedAmount = (parseFloat(calculatedAmount) + tenPercent).toString();
  ...
  const handleStakeGenz = async () => {
    ...
    try {
      ...
      const amountInWei = ethers.utils.parseUnits(adjustedAmount, selectedToken.decimals);
                  ...
                  <div className="w-full mb-6">
                    ...
                    <div className="bg-gray-100 rounded-full p-4">
                      <span className="text-xl font-semibold">
                        {requiredAmount !== null ? `${requiredAmount} ${selectedToken.symbol}` : "Calculate amount"}
                      </span>
                    </div>
                  </div>
