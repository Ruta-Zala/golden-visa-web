...
const referralRewardsList = [
  {
    rewardPercentage: "5%",
    rewardDescription: <>For up to $1,000 worth of referrals.</>,
  },
  {
    rewardPercentage: "7.5%",
    rewardDescription: <>For referrals from $1,001 to $9,999.</>,
  },
  {
    rewardPercentage: "10%",
    rewardDescription: <>For referrals from $10,000 onwards.</>,
  },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Join the IOPn ecosystem and mint OPN tokens for a chance to win a UAE Gloden Visa. Mint in your future with exclusive access and global recognition. Act now and be part of the Web3 Talent Program."
        />
        <meta
          name="description"
      ...
      <div className="w-full bg-white-0">
          ...
          <div className="container-xs mb-[254px] flex justify-center px-14 max-[1440px]:px-5 max-[1050px]:px-5">
            <div className="flex w-[90%] flex-col gap-[186px] max-[1440px]:w-full max-[1440px]:gap-[139px] max-[1050px]:w-full max-[1050px]:gap-[139px] max-[550px]:gap-[93px]">
              ...
              <div className="mx-52 flex flex-col items-center gap-12 max-[1050px]:mx-0">
                ...
                >
                  {t(
                    "Join the IOPn ecosystem and power the Web3 Talent Program. Mint OPN"
                  )}
                  <br />
                  {t("tokens for your chance at a UAE Gloden Visa")}!
                </Text>
                <Button
                  color="white_0"
                  variant="fill"
        ...
        <div
          id="refferralProgram"
          className="mb-1 mt-[118px] flex flex-col items-center"
        >
