        ...
        <div className="flex flex-col items-center gap-1.5 bg-light_base">
          ...
          <div className="relative h-[538px] self-stretch overflow-hidden">
            <div className="mt-40 px-10">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 z-30 h-[100px] w-[100px] rounded-full bg-[#000] hidden md:flex items-center justify-center">
                <button
                  ref={prevRef}
