...
const OPNChainExploreSection = () => {
  return (
    <div className="px-4 max-w-screen-2xl mx-auto relative mt-16" id="opnChain">
      ...
      <div className="flex flex-col items-center space-y-8 md:flex-row md:space-y-0 md:space-x-4 lg::space-x-8 relative">
        {/* <img
          src={cradsBg}
          alt=""
          className="absolute top-0 bottom-0 right-0 left-0 h-full w-full object-contain absolute"
        /> */}
        {cardData.map((card, index) => (
          <div
            key={index}
            className={`bg-gradient-to-b h-full ${card.gradient} text-white-0 p-4 md:p-2 lg:p-8 rounded-2xl shadow-lg w-full self-stretch z-10`}
          >
